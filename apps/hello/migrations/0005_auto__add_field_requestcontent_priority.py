...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'RequestContent.priority'
        db.add_column(u'hello_requestcontent', 'priority',
                      self.gf('django.db.models.fields.IntegerField')(default=0, max_length=1),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'RequestContent.priority'
        db.delete_column(u'hello_requestcontent', 'priority')
